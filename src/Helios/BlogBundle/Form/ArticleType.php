<?php
// src/Helios/BlogBundle/Form/ArticleType.php
...
class ArticleType extends AbstractType
{
  public function buildForm(FormBuilderInterface $builder, array $options)
  {
    $builder
      ...
      ->add('categories',  'entity',        array(
        'class'    => 'HeliosBlogBundle:Categorie',
        'property' => 'nom',
        'multiple' => true
      ))
      /*
    ...
    $builder->addEventListener(
      ...
      function(FormEvent $event) { // Ici, on définit une fonction qui sera exécutée lors de l'évènement
        ...
        if (null === $article->getUser()) {
        	...
        	$event->getForm()->add('user', 'entity', array('class' => 'HeliosUserBundle:User'));
        }
      }
    );
  }
  ...
  public function setDefaultOptions(OptionsResolverInterface $resolver)
  {
    $resolver->setDefaults(array(
      'data_class' => 'Helios\BlogBundle\Entity\Article'
    ));
  }

  public function getName()
  {
    return 'helios_blogbundle_articletype';
  }
}
