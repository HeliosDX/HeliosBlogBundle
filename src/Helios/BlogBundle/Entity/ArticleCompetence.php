<?php
// src/Helios/BlogBundle/Entity/ArticleCompetence.php
...
class ArticleCompetence
{
  /**
   * @ORM\Id
   * @ORM\ManyToOne(targetEntity="Helios\BlogBundle\Entity\Article", inversedBy="articleCompetences")
   */
  private $article;

  /**
   * @ORM\Id
   * @ORM\ManyToOne(targetEntity="Helios\BlogBundle\Entity\Competence")
   */
  private $competence;
  ...
  public function setCompetence(\Helios\BlogBundle\Entity\Competence $competence)
  {
