...
// src/Helios/BlogBundle/Validator/AntiFloodValidator.php

namespace Helios\BlogBundle\Validator;
...
class AntiFloodValidator extends ConstraintValidator
{
  ...
  public function __construct(Request $request, EntityManager $em)
  {
    ...
    $this->repository = $em->getRepository('HeliosBlogBundle:Commentaire');
  }
